"""
Django settings for mymicroservice project.
...
SECRET_KEY = 'django-insecure-8p2#qhd&14@$bkrso-c1hcwr%ji1n-9%0-pr&l@gycei+7c!xz'
...
ROOT_URLCONF = 'mymicroservice.urls'
...
WSGI_APPLICATION = 'mymicroservice.wsgi.application'
